...
class TestApproxConv2D(object):
    ...
    def __build(self):
        ...
        self.output_ref_tensor = tf.nn.conv2d(input_tensor_quant, filter_tensor_quant, self.stride, 'VALID')
...
if __name__ == '__main__':
    ...
    test = TestApproxConv2DPerAxis(test_op_module, [1, 256, 256, 3], [3, 3, 3, 5], [1, 1, 1, 1])
